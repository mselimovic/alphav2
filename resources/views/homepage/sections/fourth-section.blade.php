    ...
    <div class="container">
        <div class="grid">
            <div class="card">
                ...
                <p class="pricing">235€</p>
                <p class="text-black">Program 2 Alpha Intesiv</p>
                <hr>
                <ul class="features text-black">
                    <li>Innenraum komplett absaugen mit Sitzplätzen rausnehmen</li>
                    <li>Scheiben Reinigung innen</li>
                    <li>Cockpit mit Mittelkonsole Pflege</li>
                    <li>Fußmatten waschen + Trocken</li>
                    <li>Kofferraum absaugen, Kofferraum Rahmen und Zwischenraum Reinigung</li>
                    <li>Einstiegleisten reinigen</li>
                    <li>Geruchneutralisierung</li>
                    <li>Dachpolster Reinigung</li>
                    <li>Motorwäsche</li>
                </ul>
